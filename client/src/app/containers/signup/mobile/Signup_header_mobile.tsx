...
const SIGNUP_HEADER_MOBILE = () => {
  ...
  return (
    ...
    <div>
      <div className="flex items-stretch h-12 border lg:hidden">
        ...
        <div className="border-x border-[#d0d1d3] flex justify-between grow items-center py-3 pl-6 pr-3 font-[700] text-[16px]  leading-6 ">
          ...
          <div onClick={animationLoginSignupOnChange}>
            <span className="text-[#6328e0] affect_text">Přihlásit se</span>
          </div>
        </div>
        {/* </div> */}
      </div>
...
export default SIGNUP_HEADER_MOBILE;
